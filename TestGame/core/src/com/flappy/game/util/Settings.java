...
public class Settings {
    ...
    public static final int SCREEN_HEIGHT = 480; // denna är bara kopplad till poängen, game over screen och positionen på pingvinen än så länge.
    public static final int SCREEN_WIDTH = 800; // denna är bara kopplad till poängen, game over screen och positionen på pingvinen än så länge.
